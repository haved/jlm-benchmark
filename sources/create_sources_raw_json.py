...
class Program:
    ...
    def __init__(self, folder, cfiles, linker_workdir, ofiles, elffile, linker_arguments):
        ...
        self.linker_arguments = linker_arguments
...
def main():
    parser = argparse.ArgumentParser(description='Turn build logs into a sources-raw.json file')
    ...
    parser.add_argument('--output', dest='output', action='store', default='sources-raw.json',
                        help="The name of the destination json file [sources-raw.json]")
